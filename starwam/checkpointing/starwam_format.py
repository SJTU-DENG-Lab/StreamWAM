"""Native StarWAM inference checkpoint loading."""
...
def load_starwam_checkpoint(model: torch.nn.Module, path: Path) -> dict[str, Any]:
    """Load a native StarWAM inference checkpoint non-strictly."""
