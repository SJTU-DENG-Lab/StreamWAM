"""Cosmos-Predict2 backbone adapter for StreamWAM MoT."""
...
class CosmosPredict2Backbone(BaseBackbone):
    """Cosmos-Predict2-2B Video2World backbone for StreamWAM MoT."""
    ...
    def build_shared_dit_core(
        ...
        *,
        ...
        from streamwam.modules.causal_cosmos import CausalCosmosModel
