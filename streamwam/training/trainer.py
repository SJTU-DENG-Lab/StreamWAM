"""StreamWAM trainer: unified training loop with HuggingFace Accelerate + DeepSpeed."""
...
from streamwam.config import TrainingConfig, StreamWAMConfig
...
class StreamWAMTrainer:
    """Unified trainer for StreamWAM models.
    ...
    def _run_eval(self):
        ...
        """
        from streamwam.training.metrics import action_dim_mse, action_mse, video_psnr
