"""Preprocess StreamWAM ActionDiT initialization from video DiT weights.
...
Examples:
    python -m streamwam.tools.preprocess_action_dit_init \
        ...
        --output /path/to/preprocessed/streamwam_action_dit_init.pt \
    ...
    python -m streamwam.tools.preprocess_action_dit_init \
        ...
        --output /path/to/preprocessed/streamwam_action_dit_init_cosmos_predict2.pt \
...
def _build_action_dit_from_config(
    ...
    from streamwam.action_model import build_action_dit
...
def main() -> None:
    ...
    parser.add_argument("--config", required=True, help="StreamWAM YAML recipe used to infer ActionDiT shape.")
    ...
    payload: dict[str, Any] = {
        "policy": {
            ...
            "source": "video_state_dict" if args.video_state_dict else "streamwam_recipe_backbone",
    ...
    print(
        f"[INFO] Saved StreamWAM ActionDiT init to {out_path} "
