...
:class:`streamwam.wam.mot_wam.MoTWAM.training_step`::
...
from streamwam.config import DataConfig
    ...
    def _load_t5(self, task: str | None) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        if not cache.is_file():
            raise FileNotFoundError(
                ...
                "Run `python -m streamwam.tools.precompute_text_cache` or let training precompute it before workers start."
            )
