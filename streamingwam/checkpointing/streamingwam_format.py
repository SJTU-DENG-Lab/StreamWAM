"""Native Streaming-WAM inference checkpoint loading."""
...
def load_streamingwam_checkpoint(model: torch.nn.Module, path: Path) -> dict[str, Any]:
    """Load a native Streaming-WAM inference checkpoint non-strictly."""
