"""Streaming-WAM configuration system. Dataclass-based, no Hydra."""
...
class FrameworkConfig:
    type: str = "mot"  # Streaming-WAM first functional path: mot
    ...
    # (produced by `python -m streamingwam.tools.preprocess_action_dit_init`).
...
class TrainingConfig:
    ...
    wandb_project: str = "streamingwam"
...
def load_config(path: str | _Path) -> StreamingWAMConfig:
    """Load a YAML recipe and return a fully-populated :class:`StreamingWAMConfig`.
    ...
    Example:
        cfg = load_config("examples/libero/configs/recipes/streamingwam_libero_mot_wan22_5b.yaml")
    ...
    return _from_dict(StreamingWAMConfig, raw)


def config_to_dict(cfg: StreamingWAMConfig) -> dict:
