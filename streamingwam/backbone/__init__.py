"""Backbone builders for Streaming-WAM."""
...
from streamingwam.backbone.wan22 import Wan22Backbone
...
def build_backbone(
    ...
    *,
    ...
    """Build a Streaming-WAM backbone."""
    ...
    if config.type in COSMOS_PREDICT2_BACKBONES:
        from streamingwam.backbone.cosmos_predict2 import CosmosPredict2Backbone
    ...
    raise ValueError(
        f"Unknown Streaming-WAM backbone type: {config.type}. "
...
def build_text_encoder(
    ...
    *,
    ...
    eval (``streamingwam.eval.policy``), training cache warm-up (``builder``), and the
    ...
    if config.type in COSMOS_PREDICT2_BACKBONES:
        from streamingwam.backbone.cosmos_predict2 import CosmosPredict2TextEncoder
